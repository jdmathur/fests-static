	...
	function Wave() {
		...
		/** Bubble settings */
		var MAX_BUBBLES = 20; // The maximum number of bubbles visible before FIFO is applied
		...
		function TimeUpdate(e) {
			...
			gradientFill.addColorStop(0,'#146590');
			gradientFill.addColorStop(1,'rgba(119,206,255,.7)');
